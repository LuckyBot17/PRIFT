...
def str_to_bool(value: str) -> bool:
    """Normalize CLI boolean strings such as 'true'/'false' into actual bools."""
    ...
    if lowered == "false":
        return False
    raise ValueError(f"Boolean flag expects 'true' or 'false', but got: {value}")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=[
            "a yelp review expressing negative sentiment",
            "a yelp review expressing positive sentiment",
        ],
...
def main() -> None:
    ...
    use_true_confounder = str_to_bool(args.use_true_confounder)
    train_linear_head_flag = str_to_bool(args.train_linear_head)
